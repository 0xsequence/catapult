...
actions:
  - name: "a1"
    ...
    arguments: {}
`;
        expect(() => (0, job_1.parseJob)(yamlContent)).toThrow('"skip_if" must be an array if provided');
    });
...
actions:
  - name: "a1"
    ...
    arguments: {}
`;
        expect(() => (0, job_1.parseJob)(yamlContent)).toThrow('"skip_if" contains an invalid condition entry');
    });
});
